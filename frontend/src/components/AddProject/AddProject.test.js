...
describe('Add Project Component', () => {
  ...
  const fakeProjectName = 'SHREE Project01';
  ...
  it('Should able to Update Project ', async () => {
    ...
    let projectName;
    await wait(() => {
      projectName = getByPlaceholderText('ProjectName');
  ...
  it('Should able to Reset Project Form ', async () => {
    ...
    const projectName = getByPlaceholderText('ProjectName');
    fireEvent.change(projectName, { target: { name: 'projectName', value: fakeProjectName } });
  ...
  it('Should able to Serach the project from project List ', async () => {
    ...
    await wait(() => {
      ...
      fireEvent.change(searchInp, { target: { name: 'searchUser', value: 'Project 01' } });
    });
